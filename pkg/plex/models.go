...
type PlexAction string

const (
	PlexActionPlay     PlexAction = "media.play"
	PlexActionStop     PlexAction = "media.stop"
	PlexActionPause    PlexAction = "media.pause"
	PlexActionResume   PlexAction = "media.resume"
	PlexActionScrobble PlexAction = "media.scrobble"
)
