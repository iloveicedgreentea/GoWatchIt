...
type JellyfinSession struct {
	...
	NowViewingItem           NowViewingItem             `json:"NowViewingItem"`
	DeviceID                 string                     `json:"DeviceId"`
	...
	NowPlayingQueueFullItems []NowPlayingQueueFullItems `json:"NowPlayingQueueFullItems"`
...
type DeviceProfile struct {
	...
	TranscodingProfiles              []TranscodingProfiles `json:"TranscodingProfiles"`
...
type NowPlayingQueueFullItems struct {
	Name                         string           `json:"Name"`
	OriginalTitle                string           `json:"OriginalTitle"`
	ServerID                     string           `json:"ServerId"`
	ID                           string           `json:"Id"`
