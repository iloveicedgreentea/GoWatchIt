...
func TestDeviceFilterUUID(t *testing.T) {
	t.Parallel()
	...
	_, err = events.RequestToEvent(ctx, req)
	expErr := &events.FilterDoesNotMatchError{Message: "device UUID filter does not match"}
